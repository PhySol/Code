...
public class Given_TrainPhysicsProblem {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DATA_PATH = "PhySolData/IdealOutput_Given/";
        WORD_VECTORS_PATH = "PhySolData/PhysicsWordVectorGiven.physol";
        ...
        Given_PhysicsIterator iTrain = new Given_PhysicsIterator.Builder()
        ...
        Given_PhysicsIterator iTest = new Given_PhysicsIterator.Builder()
            .dataDirectory(DATA_PATH)
            .wordVectors(wordVectors)
            .batchSize(batchSize)
            .tokenizerFactory(tokenizerFactory)
        ...
        ModelSerializer.writeModel(net, OUTPUT_PATH + "PhySolModelGiven.net", true);
